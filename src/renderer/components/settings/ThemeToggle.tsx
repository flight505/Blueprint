...
export default function ThemeToggle() {
  ...
  return (
    <div className="space-y-2">
      <p className="text-sm font-medium mb-2 text-fg-secondary">Theme</p>
          ...
          <button
            ...
            className={`flex items-center gap-2 px-3 py-2 rounded-lg border transition-all duration-150 ${
              currentTheme === option.value
                ? 'border-purple-400/30 bg-surface-hover text-purple-400 shadow-[inset_0_0_0_1px_rgba(167,139,250,0.2),0_0_12px_rgba(167,139,250,0.12)]'
                : 'border-border-default bg-surface-raised hover:bg-surface-overlay hover:border-border-strong text-fg-secondary'
            }`}
